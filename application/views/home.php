  ...
  <!-- ======= Home Section ======= -->
  <section id="hero" class="align-items-center" style='background-image: url("assets/img/header_background_images.png");'>

    <div class="container">
      <div class="row gy-4">
        <div class="col-lg-6 order-2 order-lg-1 d-flex flex-column justify-content-center">
          <h1 class="text-white">Get the better solution with Lal Kitab</h1>
          <h2 class="text-white">Lal Kitab considered unique to Vedic astrology as it is a branch which explains how certain
        ...
        <div class="col-lg-6 order-1 order-lg-2 hero-img">
          <img src="assets/img/lal_kitab_header_img2.png" class="img-fluid animated"  alt="">
        </div>
      </div>
    </div>

  </section><!-- End Home end -->

  <section>
  <div class="container">
  <div class="row">
  <h3 class="text-danger mt-4"><strong>Today's Horoscope</strong></h3>
  ...
  <div class="col-sm-2">
    <div class="card mt-3"  style="background-color: #f4a581; opacity:0.8">
      <div class="card-body text-white">
        ...
        <div class="Source Title text-dark"><i class="bi bi-calendar-check"></i> <?php echo date ("d-M-Y"); ?></div>
      </div>
    </div>
  </div>
...
<div class="col-sm-2">
  <div class="card mt-3"  style="background-color: #f4a581; opacity:0.8">
    <div class="card-body text-white">
      <h5 class="card-title"><img src="assets/img/horoscope2.png" width="50" class="rounded float-left"/> <span class="text-dark">Taurus</span></h5>
      <p class="card-text">
...
<section style="margin-top:-100px;">
  <div class="container">
    <h3 class="text-danger"><strong>Impression</strong></h3>
  <div class="row">

  <div class="col-sm-12">
    <div class="card mt-3" style="background-color: antiquewhite; opacity:0.6; color:maroon; text-align:justify;">
    <div class="card-body">
        <p class="card-text">
        We strongly believe that astrology is a responsible field where person connect with us with a sense of trust and 
        reliability. We always respect their belief and take care of their privacy. We strive to offer the best astrology 
        solutions and predictions based on Vedic Astrology. We follow the guiding principles mentioned in the scriptures 
        of Vedic Astrology in the guid of Lal Kitrab. Thus, there is no scope of faulty predictions and solutions from our experts. 
        We have a team of astrologers that are not only experienced but also certified and educated professionals that work on \
        combining the ancient wisdom with modern times. <br/><br/>
        How about getting an instant solution to your issues with astrology consultation on the phone converstion or Face to Face
        meetings or video consultation?
        You can now get answers to your long-standing issues by astrological experts at Astro Jigyasa. Speaking to 
        our experienced and expert astrologers on any medium of conversation can help in resolving your life issues 
        and getting the best solutions that change your life positively. 
        </p>
...
<a class="nav-link scrollto" href="<?php echo base_url('About-Us'); ?>">
<button class="btn btn-danger mt-3">Read more about us...</button>
</a>
</div>
</section>
...
<section style="margin-top:-100px;">
  <div class="container">
    <h3 class="text-danger"><strong>Get Expert Solution</strong></h3>
  <div class="row">

  <div class="col-sm-3">
    <div class="card mt-3" style="background-color:seashell;" >
    <div class="card-body">
       <img src="assets/img/expert_solution1.png" width="100%" style=" border: 2px solid #d71920;"/>
      </div>
    </div>
  </div>
  ...
  <div class="col-sm-3">
    <div class="card mt-3" style="background-color:seashell;" >
    <div class="card-body">
      <img src="assets/img/expert_solution2.png" width="100%" style=" border: 2px solid #d71920;"/>
      </div>
    </div>
    </div>
  ...
  <div class="col-sm-3">
    <div class="card mt-3" style="background-color:seashell;" >
    <div class="card-body">
      <img src="assets/img/expert_solution3.png" width="100%" style=" border: 2px solid #d71920;"/>
      </div>
    </div>
    </div>
  ...
  <div class="col-sm-3">
    <div class="card mt-3" style="background-color:seashell;" >
    <div class="card-body">
      <img src="assets/img/expert_solution4.png" width="100%" style=" border: 2px solid #d71920;"/>
      </div>
    </div>
  </div>

</div>
<a class="nav-link scrollto" href="<?php echo base_url('Services'); ?>">
